'''
    ...
    2. Latte Panda or Raspberry Pi Model 3 B+ or Desktop --> For Computer Vision
    3. Arduino and Motor
    4. HYUNDAI new AVANTE XD 1.6 VVT
        ...
        if lines is not None:
            ...
            if math.fabs(avg_theta * (180.0) / math.pi) > 80 and math.fabs(avg_theta * (180.0) / math.pi) < 100 and math.fabs(avg_rho) < (SCREEN_HEIGHT/2) and is_Stop_at_StopLine == False:
                ...
                if is_Stop_at_StopLine == True:
                    return 0.0, True, original_image
        else:
...
def image_processing(img):
    ...
    cv2.imshow('gamma_edge',cv2.Canny(gamma_correction, 130, 250, apertureSize=3))
